...
public class Attend {
 private int id;
    ...
    // コンストラクタオーバーロード
    public Attend(int id, LocalDateTime workStart, LocalDateTime workEnd, LocalDateTime breakStart,LocalDateTime breakEnd,
    ...
    public Attend processLine(String line)
    {
        ...
        Attend attend = new Attend(id, workStart, workEnd, breakStart, breakEnd, lateness, leaveEarly, outing, overWork);
        return attend;
    }
